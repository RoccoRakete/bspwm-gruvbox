...
# pacman
sudo pacman -S dunst xfce4-settings gvfs thunar-volman kate jq xorg-xrandr neofetch gnome-keyring libsecret libgnome-keyring seahorse stalonetray feh rofi kitty bspwm polybar thunar thunar-archive-plugin firefox lightdm thunderbird flatpak picom pavucontrol sxhkd fish htop btop git xfce4-power-manager dunst xorg-xsetroot playerctl papirus-icon-theme
